...
export const getProfileOrdersSummaryStatus = ({ params }) =>
    request('profile/orders/summary/status', 'get', params);

export const getProfileOrderByOrderNo = ({ path: { orderNo } }) =>
    request(`profile/orders/${orderNo}`, 'get');

export const getGuestOrderByOrderNo = ({ path: { orderNo } }) =>
    request(`guest/orders/${orderNo}`, 'get');
...
export const postOrderSheetCalculate = ({ pathVariable, requestBody }) =>
    request(
        `order-sheets/${pathVariable.orderSheetNo}/calculate`,
        'post',
        null,
        requestBody,
    );

export const postProfileOrderCancelByOrderOptionNo = ({
    path: { orderOptionNo },
    requestBody,
}) =>
    request(
...
export const getShippingsEncryptedShippingNoLaterInput = (
    encryptedShippingNo,
...
export const postCart = (requestBody) =>
    request('cart', 'post', null, requestBody);

export const putCart = (requestBody) =>
    request('cart', 'put', null, requestBody);

export const postGuestCart = (requestBody) =>
    request('guest/cart', 'post', null, requestBody);

export const deleteCart = (query) => request('cart', 'delete', query);

export const getCartCount = () => request('cart/count', 'get');

export const getWish = (query) =>
    request('profile/like-products', 'get', query);

export const getOrderConfigs = () =>
    request('order-configs', 'get', null, null);
