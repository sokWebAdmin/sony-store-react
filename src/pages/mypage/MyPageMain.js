          ...
          <div className="cont_inner">
            <div className="cont history_order">
              ...
              <div className="history_inner">
                  ...
                  <ul className="order_list">
                    <li className="step_1 on">{/* 1건 이상 부터 class: on 추가 */}
                      <div className="ship_box">
                        ...
                        <a className="val_txt"><span
                          className="val">4</span><span>건</span></a>
                      </div>
                    </li>
                    <li className="step_2">
                      <div className="ship_box">
                        ...
                        <a className="val_txt"><span
                          className="val">0</span><span>건</span></a>
                      </div>
                    </li>
                    <li className="step_3">
                      <div className="ship_box">
                    ...
                    <li className="step_4 on">
                      <div className="ship_box">
                        ...
                        <a className="val_txt"><span
                          className="val">1</span><span>건</span></a>
                      </div>
                    </li>
                ...
                <div className="my_claim">
                  <p className="txt cancel on">주문 취소 <a title="주문 취소 건"><strong
                    className="val_txt"><span
                    className="val">4</span> 건</strong></a></p>
                  <p className="txt return">교환 반품 <a title="교환 반품 건"><strong
                    className="val_txt"><span
                    className="val">0</span> 건</strong></a></p>
                </div>
              </div>
            </div>
            ...
            <div className="cont history_coupon">
              ...
              <div className="history_inner">
                <div className="history_list">
                  <div
                    className="coupon_inner on">{/* class : on 내역이 있을 경우 on */}
                    <div className="coupon_list">
                      <div className="coupon_box">
                        <div className="coupon">
                          <span className="coupon_no">No. <span
                            className="num">3757897055</span></span>
                          <p className="tit">정품등록감사<br /> 소니 액세서리 <span
                            className="percentage">10%</span> 할인</p>
                          <p className="cut_txt">3만원 이상 구매 시 </p>
                          <p className="expiration_txt"><strong>유효 기간 </strong>2021.05.21
                            ~ 2021.06.12</p>
                        </div>
                      </div>
                      <div className="coupon_box">
                ...
                <div className="guide_list">
                  ...
                  <ul className="list_dot">
                    <li>쿠폰은 <strong>주문당 1매씩 사용 가능하며, 제품 1개에만 적용</strong>됩니다.
                    </li>
                    <li>쿠폰 할인은 결제 시점에서 자동으로 할인 금액만큼 차감되며 결제 예정금액이 표시됩니다.</li>
                    <li>쿠폰은 주문 후 취소할 경우 재발급되지 않으니 사용에 유의하여 주시기 바랍니다.</li>
                    <li>소니스토어에서 발행하는 쿠폰은 행사 내용에 따라 기간 및 해당 제품 등 적용 방법이 다를 수
                      있습니다.
                    </li>
                  </ul>
                </div>
                <div className="ico_box_link">
                  ...
                  <a href="https://www.sony.co.kr/scs/handler/SCSWarranty-Start"
