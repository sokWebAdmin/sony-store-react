...
import MobileAuth from 'pages/member/MobileAuth';
import AuthPassword from 'pages/mypage/myPageMember/AuthPassword';
    ...
    const handleSubmit = async (event) => {
        ...
        if (request) {
            ...
            if (ret.data.errorCode === '0000') {
                fetchMyProfile(profileDispatch, {
                    type: '30',
