                ...
                <>
                  <div className="member_withdrawal">
                    <a
                      ...
                      onClick={(event) => handleClick(event, 'withdrawal')}
                    >
                      회원탈퇴
                    </a>
                  </div>
                  <div className="member_info_list">
                    <div className="member_list name">
                      <div className="tit_inner">
                        <label htmlFor="member_name" className="tit">
                          이름
                        </label>
                      </div>
                    ...
                    <div className="member_list tel">
                      <div className="tit_inner">
                        <label htmlFor="member_tel" className="tit">
                          휴대폰
                        </label>
                      </div>
                      <div className="info_inner">
                    ...
                    <div className="member_list email">
                      <div className="tit_inner">
                        <label htmlFor="member_email" className="tit">
                          이메일 아이디
                        </label>
                      </div>
                      <div className="info_inner">
                    ...
                    <div className="member_list birth_date">
                      <div className="tit_inner">
                        <label htmlFor="member_birth" className="tit">
                          생년월일
                        </label>
                      </div>
                      <div className="info_inner">
                    ...
                    <div className="member_list gender">
                      <div className="tit_inner">
                        <label htmlFor="member_gender" className="tit">
                          성별
                        </label>
                      </div>
                      <div className="info_inner">
                    ...
                    <div className="member_list grade">
                      <div className="tit_inner">
                        <label htmlFor="member_grade" className="tit">
                          회원구분
                        </label>
                      </div>
                      <div className="info_inner">
                        <div className="info_box">
                          <div className="data_box">
                            <div className="inp_box">
                              <span
                                className={
                                  memberGrade[myForm.custgrade]?.className
                                    ? `ico_grade ${memberGrade[myForm.custgrade]?.className}`
                                    : ''
                                }
                              >
                                <input
                    ...
                    <div className="member_list password">
                      <div className="tit_inner">
                        <label htmlFor="member_password" className="tit">
                          비밀번호
                        </label>
                      </div>
                      <div className="info_inner">
                        <div className="info_box type_txt_btn">
                          ...
                          <div className="btn_box">
                            ...
                            {repasswordVisible && <Repassword setVisible={setRepasswordVisible} />}
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="member_list address">
                      <div className="tit_inner">
                        <label htmlFor="member_addr" className="tit">
                          주소
                        </label>
                      </div>
                      <div className="info_inner">
                        ...
                        <div className="info_box">
                          ...
                          <p className="name_desc">
                            ※ 주소는 사은품 및 기타 서비스를 제공받으실 때, 꼭 필요한 부분이므로 정확히 기입해 주시기
                            바랍니다.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="btn_article">
                    {isEditMode ? (
                      <>
                        ...
                        <button className="button button_positive" type="submit">
                          저장
                        </button>
                      </>
                    ) : (
