...
export default function Rename() {
  ...
  return (
    <>
      ...
      {
        confirmVisible && <Confirm onClose={ authType === 'mobile' ? mobileConfirm : ipinConfirm }>{ confirmMessage }</Confirm>

      }
      <div className="contents mypage">
        <div className="rename_wrap">
          <div className="common_head first_tit">
            <Link href="/my-page" className="common_head_back">마이페이지</Link>
          ...
          <div className="certify_zone">
            ...
            <div className="btn_article">
              ...
              <button className="button button_positive" type="button" onClick={ event => handleClick(event, 'close') }>확인</button>
            </div>
