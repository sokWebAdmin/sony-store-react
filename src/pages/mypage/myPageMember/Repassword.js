...
export default function Repassword({ setVisible }) {
  ...
  return (
    <LayerPopup className="password_change" onClose={close}>
          ...
          <div className="form_zone">
            <div className="input_item">
                ...
                <div className={`inp_box password_box ${passwordType.password && 'active'}`}>
                  <label className="inp_desc" htmlFor="popPw">
                    ...
                    <div className="eyes">
                      <button
                        type="button"
                        title={`${passwordType.password ? '비밀번호 숨김' : '비밀번호 표시'}`}
                        onClick={(e) => handlePassword(e, 'password')}
                      >
              ...
              <div className="group">
                <div className={`inp_box password_box ${passwordType.newPassword && 'active'}`}>
                  <label className="inp_desc" htmlFor="popPw">
                    ...
                    <div className="eyes">
                      <button
                        type="button"
                        title={`${passwordType.newPassword ? '비밀번호 숨김' : '비밀번호 표시'}`}
                        onClick={(e) => handlePassword(e, 'newPassword')}
                      >
                        <i className={`ico ${passwordType.newPassword ? 'ico_eyes' : 'ico_eyes_open'}`}></i>
                      </button>
                    </div>
                  </label>
                </div>
                <div className="error_txt">
                  ...
                  영문 대/소문자, 숫자를 혼합하여 12자리 이상 15자리 미만으로 입력하시기 바랍니다. 일부 특수문자도 사용
                  가능합니다.
                </div>
              </div>
              <div className="group">
                  ...
                  <label className="inp_desc" htmlFor="popPw">
                    ...
                    <div className="eyes">
                      <button
                        type="button"
                        title={`${passwordType.newPassword ? '비밀번호 숨김' : '비밀번호 표시'}`}
                        onClick={(e) => handlePassword(e, 'valNewPassword')}
                      >
                        <i className={`${passwordType.valNewPassword ? 'ico ico_eyes' : 'ico_eyes_open'}`}></i>
                      </button>
                    </div>
                  </label>
                </div>
                <div className="error_txt">
                  <span className="ico"></span>새 비밀번호가 일치하지 않습니다.
                </div>
              </div>
            </div>
            <div className="btn_article">
              <button className="button button_positive button-full" type="button" onClick={handleSubmit}>
                비밀번호 변경
              </button>
            </div>
            <div className="guide_list">
              ...
              <ul className="list_dot">
                <li>
                  <strong>영문 대문자와 소문자, 숫자 조합으로 12자리 이상 15자리 미만으로 입력</strong>해 주세요.
                </li>
                <li>
                  <strong>일부 특수문자도 사용 가능합니다.</strong>
                </li>
                <li>
                  아이디와 같은 비밀번호나 주민등록번호, 생일, 전화번호 등 개인정보와 관련된 숫자, 연속된 숫자, 반복되는
                  숫자 등은 타인이 쉽게 알아낼 수 있어 유출의 위험이 있으니 사용하지 않는 것이 좋습니다.{' '}
                </li>
                <li>이전에 사용된 비밀번호를 재사용하시면 도용의 우려가 있으니 새로운 비밀번호로 사용해 주세요.</li>
                <li>
                  소니스토어에서 사용하는 자체 비밀번호는 회원 정보 수정 및 회원 탈퇴 시에 꼭 필요합니다.(가입 시 이용한
                  각 SNS 계정 비밀번호와는 다름)
                </li>
                <li>
                  비밀 번호는 주기적으로 변경해 주세요. (<strong>최소 3개월에 1회</strong>는 변경해 주시는 것이
                  좋습니다.)
                </li>
                <li>
                  타 사이트와 동일하거나 유추할 수 있는 비밀 번호는 도용의 위험이 크니, 안전도가 높은 비밀 번호로
                  변경하시길 권장합니다.{' '}
                </li>
                <li>
                  <strong>SNS 계정으로 가입하신 회원님은 각 SNS 페이지에서 수정 및 변경하시기 바랍니다.</strong>
                </li>
              </ul>
            </div>
          </div>
