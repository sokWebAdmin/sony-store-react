                ...
                <div className="foot_cont">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          ① Sony Store라 함은 회사가 재화 또는 용역(이하 재화등이라 함)을 이용자에게 제공하기위해 컴퓨터등 정보통신설비를 이용하여 상품을 거래할 수 있도록
                          설정한
                        ...
                        <li>
                          ③ 회원이라 함은 Sony Store에 개인정보를 제공하여 회원등록을 한 자로서 Sony Store가 제공하는 정보를 지속적으로 받으며 Sony Store의
                          서비스를
                        ...
                        <li>
                          ⑤ 회원아이디(ID)라 함은 회원의 식별과 서비스 이용을 위해 회원이 정하고 Sony Store가 승인하는 문자 또는 숫자의 조합으로 회사가 운영하는 다른
                          인터넷사이트와 동일하게 사용하게 됩니다. 단, Sony Store에 가입한 회원이 소니픽쳐스 코리아가 제공하는 콜럼비아 트라이스타 사이트에 회원으로 가입하는
                          경우,
                          Sony Store와 동일한 회원 아이디(ID)와 비밀번호를 사용해야 합니다.
                        </li>
                        <li>
                          ⑥ Sony Store 멤버십제도는 Sony Store 온라인 가입 회원에게 해당되는 것으로 상품구입시 마일리지 제공 및 기타 이벤트 참가기회 제공 등 차별화된
                          서비스를 제공하는 것을 말합니다.
                        </li>
                      </ol>
                    </li>
                    <li>
                      ...
                      <ol>
                        <li>
                          ① Sony Store는 본 약관의 내용과 상호 및 대표자 성명, 영업소소재지(및 소비자의 불만을 처리할 수 있는 곳의 주소), 전화번호, fax번호,
                          전자우편주소,
                          사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자 등을 이용자가 알 수 있도록 Sony Store의 초기화면에 게시합니다. 단, 약관의 내용은 이용자가
                          연결화면을 통하여 볼 수 있도록 할 수 있습니다.
                        </li>
                        <li>
                          ② Sony Store는 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용중 청약철회, 배송책임, 환불조건 등과 같은 중요한 내용을 이용자가 이해할 수
                        ...
                        <li>
                          ④ 회사가 본 약관을 이용자에게 불리하게 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 Sony Store는 개정전 내용과
                          개정후
                          내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.
                        </li>
                        <li>
                          ⑤ 회사가 약관을 개정할 경우에는 그 개정약관은 적용일자 이후에 체결된 계약에만 적용되고 그 이전에 이미 체결된 계약에 관해서는 개정전의 약관이 적용됩니다. 단,
                          이미 계약을 체결한 이용자가 개정약관의 적용을 받기를 원하는 뜻을 제④항의 공지기간내 Sony Store에 송신하여 Sony Store의 동의를 받은 경우는
                          개정약관
                          조항이 적용됩니다.
                        </li>
                        <li>
                          ⑥ 본 약관에 명시되지 않은 사항과 본 약관의 해석에 관해서는 전자상거래등에서의 소비자보호에 관한 법, 약관의규제등에 관한 법,공정거래위원회가 정하는
                          전자상거래등에서의 소비자보호지침 및 관계법령 또는 상관례에 따릅니다.
                        </li>
                      </ol>
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ② Sony Store는 재화등의 품절 또는 기술적 사양이 변경되는 등의 경우에는 장차 체결되는 계약에 의해 제공할 재화등의 내용을 변경할 수 있으며 이경우
                          변경된
                          재화등의 내용 및 제공일자를 명시하여 현재의 재화등의 내용을 게시한 곳에 즉시 공시합니다.
                        </li>
                        <li>
                          ③ Sony Store가 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화등의 품절 또는 기술적 사양의 변경등의 이유로 변경할 경우 그 사유를 이용자에게
                          통지가능한 주소로 즉시 통지합니다.
                        </li>
                        <li>
                          ④ 전항의 경우 Sony Store 로 인하여 이용자가 입은 손해를 배상합니다. 단, Sony Store에 고의 또는 과실이 없음을 입증하는 경우에는 그렇지
                          않습니다.
                        </li>
                      </ol>
                    </li>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ② Sony Store는 전항의 사유로 서비스의 제공이 일시적으로 중단됨으로 인하여 이용자 또는 제3자가 입은 손해에 대하여 배상합니다. 단, Sony
                          Store가
                          고의 또는 과실이 없음을 입증하는 경우에는 그렇지 않습니다.
                        </li>
                        <li>
                          ③ 사업종목의 전환, 사업의 포기, 업체간 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우 Sony Store는 제10조에서 정한 방법으로 이용자에게
                          통지하고
                          당초 Sony Store에서 제시한 조건에 따라 소비자에게 보상합니다. 단, Sony Store보상기준 등을 고지하지 아니한 경우에는 이용자들의 마일리지 또는
                          적립금
                          등을 Sony Store에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.
                        </li>
                      </ol>
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ...
                          회사는 고객의 편의를 위해 회사의 패밀리사이트인 Sony Store와 SCS사이트의 통합회원제도를 운영하고 있습니다. 이를 위해 본 회사가 수집한 개인정보는
                          아래의
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ④ Sony Store가 회원자격을 제한,정지시킨 후 동일한 행위가 2회이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 Sony Store는
                          회원자격을 상실시킬 수 있습니다.
                        </li>
                        <li>
                          ⑤ Sony Store가 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고 회원등록 말소전에 최소한 30일 이상의 기간을
                          정하여
                          소명할 기회를 부여합니다.
                        </li>
                        <li>
                          ⑥ 단, 회사의 회원가입절차 채택 및 회원ID 통합실시 이전에 가입한 회원으로서, 회사가 보낸 실명확인절차 이행 안내 및 회원 ID 변경을 요청한 전자우편을
                          받고도
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          ① 회원자격을 상실하게 되는 경우 Sony Store는 회원의 개인정보를 즉시 파기,삭제하며 제10조 1항의 방법으로 개별통보합니다. 단, 개인정보취급방침에 따라
                          회사가 보존해야 하는 개인정보의 경우는 예외로 합니다.
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ② 단, 불특정다수의 회원에 대한 통지는 1주일이상 Sony Store 화면에 게시함으로써 개별통지에 대신할 수 있습니다. 단, 회원 본인의 거래에 관련하여
                          중대한
                ...
                <div className="foot_cont">
                  ...
                  <ul>
                    <li>
                      ...
                      <p>
                        이용자는 Sony Store에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며 Sony Store는 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기
                        쉽게
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          ① Sony Store는 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일이내에 재화등을 배송할 수 있도록 주문제작,
                          포장등 기타의 필요한 조치를 취합니다. 단, Sony Store가 이미 재화등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터
                          2영업일
                          이내에 조치를 취합니다. 이때 Sony Store는 이용자가 재화등의 공급 절차 및 진행사항을 확인할 수 있도록 적절한 조치를 합니다.
                        </li>
                        <li>
                          ② 수신확인통지를 받은 이용자는 의사표시의 불일치등이 있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고 Sony Store는
                          배송전에 이용자의 요청이 있는 경우에는 지체없이 그 요청에 따라 처리하여야 합니다. 다만, 이미 대금을 지불한 경우에는 제17조의 청약철회 등에 관한 규정에
                          따릅니다.
                        </li>
                      </ol>
                    </li>
                    ...
                    <li>
                      ...
                      <p>
                        Sony Store는 이용자가 구매신청한 재화등이 품절등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를 이용자에게 통지하고 사전에 재화등의 대금을
                        받은 경우에는 대금을 받은 날부터 2영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.
                      </p>
                    </li>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ③ 제2항 나호 내지 라호의 경우 Sony Store가 사전에 청약철회등이 제한되는 사실을 소비자가 쉽게 알 수 있는 곳에 명기하거나 시용상품을 제공하는 등의
                          조치를
                          하지 않았다면 이용자의 청약철회등이 제한되지 않습니다.
                        </li>
                        <li>
                          ④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화등의 내용이 표시,광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화등을 공급받은 날부터
                          3월이내,
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          ① Sony Store는 이용자로부터 재화등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화등의 대금을 환급합니다. 이 경우 Sony Store가 이용자에게
                        ...
                        <li>
                          ③ 청약철회등의 경우 공급받는 재화등의 반환에 필요한 비용은 이용자가 부담합니다. Sony Store는 이용자에게 청약철회등을 이유로 위약금 또는 손해배상을
                          청구하지
                ...
                <div className="foot_cont">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <p>
                        이용자 또는 이용자의 법정대리인은 언제나 자신 또는 자신이 보호하는 아동의 개인정보를 열람, 정정하거나 삭제를 요청할 수 있으며, Sony Store는 이용자 또는
                        이용자의 법정대리인으로부터 요청을 받은 즉시 필요한 조치를 합니다. 이용자 또는 이용자의 법정대리인이 오류의 정정을 요구한 경우 그 오류를 정정할 때까지 당해
                        개인정보를
                        이용하지 않습니다.
                      </p>
                    </li>
                    <li>
                      ...
                      <ol>
                        <li>
                          ① Sony Store는 개인정보보호를 위해 관리자를 한정하며 그 수를 최소화하며 신용카드, 은행계좌등을 포함한 이용자의 개인정보의 분실, 도난, 유출,
                          변조등으로
                          인한 이용자의 손해에 대하여 모든 책임을 집니다.
                        </li>
                        <li>
                          ② Sony Store의 개인정보보호에 관한 보다 자세한 내용은 Sony Store 개인정보보호정책을 참고하시기 바랍니다. 개인정보와 관련된 문의사항은
                          개인정보관리책임자 및 담당자에게 요청하시기 바랍니다.
                        </li>
                      </ol>
                    </li>
                  </ul>
                ...
                <div className="foot_cont">
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        <li>
                          ① Sony Store는 법령과 본 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 본 약관이 정하는 바에 따라 지속적이고 안정적으로 상품을 제공하는 데
                          최선을 다하여야 합니다.
                        </li>
                        <li>
                        ...
                        <li>
                          ③ Sony Store가 상품이나 용역에 대하여 표시,광고의공정화에관한법률 제3조 소정의 부당한 표시,광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할
                          책임을 집니다.
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ③ 회원이 자신의 ID 및 비밀번호를 도난당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로 Sony Store에 통보하고 Sony Store의 안내가 있는
                          경우에는 그에 따라야 합니다.
                        </li>
                      </ol>
                    </li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ③ 적립된 마일리지는 Sony Store및 off line Sony직영점, Sony공식서비스센터 (제품 수리 서비스 이용시)에서 현금처럼 사용할 수 있으며,
                          1마일리지는 1원으로 환산됩니다. 다만, 회사는 환산비용을 변경할 수 있으며 이 경우 약관 3조 4항에 따라 고지합니다.
                        </li>
                        <li>
                          ④ 회원탈퇴 또는 회원자격상실시 멤버십제도의 사용권한도 소멸되므로 적립된 마일리지는 소멸됩니다.
                        </li>
                        <li>
                          ⑤ 위 사항외에 상세한 멤버십제도 관련 마일리지 사용방법, 제공방법, 적립방법, 적립한도등에 대해서는 Sony Store 화면의 마일리지 안내란을 참고하시기
                          바랍니다.
                        </li>
                        <li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ② 연결 몰은 피연결 몰이 독자적으로 제공하는 재화등에 의하여 이용자와 행하는 거래에 대해서는 보증책임을 지지 않는다는 뜻을 연결 몰의 초기화면 또는 연결되는
                          시점의
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          ① Sony Store가 작성한 저작물에 대한 저작권 및 기타 지적 재산권은 Sony Store에 귀속합니다. 단, 음악방송 및 영화관련 컨텐츠에 이용되는 저작물
                          등에 대하여는 다른 저작권자에게 저작권이 귀속되는 경우가 있습니다.
                        </li>
                        <li>
                          ② 이용자는 Sony Store를 이용함으로써 얻은 정보 중 Sony Store이나 기타의 저작권자에게 지적재산권이 귀속된 정보를 Sony Store의 사전 승낙
                          없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 해서는 안됩니다.
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <p>
                        재화등에 내장되거나 별도로 재화등과 함께 고객에게 제공되는 일체의 컴퓨터 프로그램은 회사가 당해 프로그램의 소유자와 적법한 라이센스계약등을 통해서 프로그램사용권을
                        부여
                        받은 것입니다. 이용자는 구입한 재화등의 유기적 일체로서 컴퓨터프로그램을 사용할 수 있으나 이를 별도로 분리하거나 이를 복제, 편집, 제3자에게 임대할 수 없습니다.
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ② 수리서비스의 제공과 관련하여 고객은 서비스를 제공받기 이전에 재화등의 하드드라이브에 설치한 소프트웨어를 포함하여 저장된 모든 데이터와 하드드라이브의 내용을
                          백업해야 하고 재화등에 부속한 테이프, CD, 디스켓, 메모리스틱등 데이터가 저장되어 있는 모든 부속물을 제거하여야 합니다. 수리서비스를 제공하는 동안 고객의
                          하드드라이브 내용이 소실되거나 재포맷 될 가능성이 많으며 회사는 수리서비스를 제공하는 동안 발생할 수 있는 재화등에 저장되거나 재화등의 부속물에 저장된 프로그램,
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ② Sony Store의 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그 사항을 처리합니다. 다만, 신속한 처리가 곤란한 경우에는 이용자에게 그 사유와
                          처리일정을 즉시 통보해 드립니다.
                        </li>
                        <li>
                          ③ Sony Store와 이용자간에 발생한 전자상거래 분쟁과 관련하여 이용자의 피해구제신청이 있는 경우에는 공정거래위원회 또는 시,도지사가 의뢰하는 분쟁조정기관의
                          조정에 따를 수 있습니다.
                        </li>
                      </ol>
                    </li>
                    <li>
                      ...
                      <ol>
                        <li>
                          ① Sony Store와 이용자간 발생한 전자상거래 분쟁에 관한 소송은 제소 당시의 이용자의 주소에 의하고 주소가 없는 경우에는 거소를 관할하는 지방법원의
                          전속관할로
              ...
              <div className="scroll_inner">
                <div className="foot_cont">
                  ...
                  <ul>
                    <li>
                      <h5 className="Fh5_tit first" id="article01">제1조 (목적)</h5>
                      <p>본 약관은 소니코리아주식회사 (이하 회사라 합니다.)가 운영하는 사이버 고객지원 페이지인 Sony Customer Station (이하 SCS 이라 합니다.)이
                        제공하는 인터넷관련 서비스 (이하 서비스라 합니다.)를 이용함에 있어 SCS와 이용자의 권리, 의무 및 책임사항을 규정하는 것을 목적으로 합니다. 본 약관은 "온라인
                        수리요금 결제 서비스 이용약관" 및 "소니 아카데미 유료강좌 이용약관"에서 특별히 정하지 않은 사항에 대해서도 공통적으로 적용됩니다.</p>
                    </li>
                    <li>
                      <h5 className="Fh5_tit" id="article02">제2조 (정의)</h5>
                      <ol>
                        ...
                        <li>
                          ② 회원이라 함은 SCS에 개인정보를 제공하여 회원등록을 한 자로서, SCS의 정보를 지속적으로 제공받으며, SCS가 제공하는 서비스를 계속적으로 이용할 수 있는
                          자를 말합니다.
                        </li>
                        <li>
                        ...
                        <li>
                          ④ 회원아이디(ID)라 함은 회원의 식별과 서비스 이용을 위해 회원이 정하고 SCS가 승인하는 문자 또는 숫자의 조합으로 회사가 운영하는 다른 인터넷사이트와
                          동일하게
                          사용하게 됩니다.
                        </li>
                      </ol>
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          ① SCS는 본 약관의 내용과 상호 및 대표자 성명, 영업소소재지(및 소비자의 불만을 처리할 수 있는 곳의 주소), 전화번호, fax번호, 전자우편주소,
                          사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자 등을 이용자가 알 수 있도록 SCS의 초기화면에 게시합니다. 단, 약관의 내용은 이용자가 연결화면을 통하여
                          볼
                          수 있도록 할 수 있습니다.
                        </li>
                        <li>
                          ② SCS는 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용 중 청약철회, 배송책임, 환불조건 등과 같은 중요한 내용을 이용자가 이해할 수 있도록
                          별도의
                          연결화면 또는 팝업화면 등을 제공하여 이용자의 확인을 구하여야 합니다.
                        </li>
                        <li>
                          ③ 본 약관은 전자상거래 등에서의 소비자보호에 관한 법률, 약관의 규제 등에 관한 법률, 전자거래기본법, 전자서명법, 정보통신망이용촉진 및 정보보호 등에 관한
                          법률,
                          방문판매 등에 관한 법률, 소비자보호법 등 관련법을 위반하지 않는 범위 내에서 개정될 수 있습니다.
                        </li>
                        <li>
                          ④ 회사가 본 약관을 개정할 경우 적용일자 및 개정사유를 명시하여 현행약관과 함께SCS초기화면에 적용일자 7일 이전부터 적용일자 전일까지 공지합니다. 다만
                          이용자에게
                          불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 SCS는 개정 전 내용과 개정 후 내용을 명확하게 비교하여
                          이용자가 알기 쉽도록 표시합니다.
                        </li>
                        <li>
                          ⑤ 회사가 약관을 개정할 경우에는 그 개정약관은 적용일자 이후에 체결된 계약에만 적용되고 그 이전에 이미 체결된 계약에 관해서는 개정전의 약관이 적용됩니다. 단,
                          이미 계약을 체결한 이용자가 개정약관의 적용을 받기를 원하는 뜻을 제④항의 공지기간 내 SCS에 송신하여 SCS의 동의를 받은 경우는 개정약관 조항이 적용됩니다.
                        </li>
                        <li>
                          ⑤ 회사가 약관을 개정할 경우에는 그 개정약관은 적용일자 이후에 체결된 계약에만 적용되고 그 이전에 이미 체결된 계약에 관해서는 개정전의 약관이 적용됩니다. 단,
                          이미 계약을 체결한 이용자가 개정약관의 적용을 받기를 원하는 뜻을 제④항의 공지기간 내 SCS에 송신하여 SCS의 동의를 받은 경우는 개정약관 조항이 적용됩니다.
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ② SCS는 재화 등의 품절 또는 기술적 사양이 변경되는 등의 경우에는 장차 체결되는 계약에 의해 제공할 재화 등의 내용을 변경할 수 있으며 이 경우 변경된 재화
                          등의 내용 및 제공일자를 명시하여 현재의 재화 등의 내용을 게시한 곳에 즉시 공시합니다.
                        </li>
                        <li>
                          ③ SCS가 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화 등의 품절 또는 기술적 사양의 변경 등의 이유로 변경할 경우 그 사유를 이용자에게 통지 가능한
                          주소로 즉시 통지합니다.
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ② SCS는 전항의 사유로 서비스의 제공이 일시적으로 중단되는 경우 이용자가 SCS에 제출한 전자우편 주소로 개별 통지하거나 1주일 이상 게시판에 게시함으로써
                          개별
                          통지에 갈음할 수 있습니다.
                        </li>
                      </ol>
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ③ SCS는 전 ①,②항과 같이 회원가입을 신청한 이용자중 다음의 각호에 해당하지 않는 한 회원으로 등록합니다. 가. 가입신청자가 이 약관 제8조 에 의하여
                          이전에
                          회원자격을 상실한 적이 있는 경우 단, 회원자격 상실 후 3년이 경과한 자로서 회원재가입 승낙을 얻은 경우에는 예외로 한다. 나. 등록내용에 허위, 누락, 오기가
                          있는 경우 다. 비실명으로 가입하는 경우 또는 실명이 확인되지 않은 경우 라. 만 14세 미만의 어린이의 경우 어린이의 개인정보를 보호하고 광고성 메일에 노출되는
                          것을 방지하기 위해 만14세 미만의 아동에 대해서는 SCS회원 가입을 허락하지 않습니다. 보증기간 연장신청 등을 위해 필요하실 경우 부모님이나 법정대리인이 직접
                          신청해 주시기 바랍니다. 단, 기존에 법정대리인의 동의하에 회원에 가입한 14세 미만 어린이는 그대로 유효하게 회원자격을 유지합니다. (2004년 12월 20일
                          부로
                          개정) 마. 기타 회원으로 등록하는 것이 SCS의 기술상 또는 업무 수행상 현저히 지장이 있다고 판단하는 경우
                        </li>
                      </ol>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>④ SCS가 회원자격을 제한,정지시킨 후 동일한 행위가 2회이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 회원자격을 상실시킬 수 있습니다.
                        </li>
                        <li>⑤ 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고 회원등록 말소 전에 최소한 30일 이상의 기간을 정하여 소명할 기회를
                          부여합니다.
                        </li>
                        <li>⑤ 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고 회원등록 말소 전에 최소한 30일 이상의 기간을 정하여 소명할 기회를
                          부여합니다. 기간 내 실명확인 및 ID변경절차를 이행하지 않은 회원의 경우 당해 기간 경과 후 30일이 지나면 회원자격을 상실시킬 수 있습니다.
                        </li>
                      </ol>
                    </li>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>② 회원자격을 상실하게 되는 경우 SCS는 회원의 개인정보를 즉시 파기,삭제하며 제10조 1항의 방법으로 개별 통보합니다. 단, 전항에 의해 회사가 보존해야
                          하는
                          개인정보의 경우는 예외로 합니다.
                        </li>
                      </ol>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>② 단, 불특정다수의 회원에 대한 통지는 1주일이상 SCS 화면에 게시함으로써 개별통지에 대신할 수 있습니다. 단, 회원 본인의 거래에 관련하여 중대한 영향을
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        <li>① 이용자는 SCS에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며 SCS는 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야
                          합니다. 단, 회원인 경우 나호내지 라호의 적용을 제외할 수 있습니다.
                          <ul>
                            <li>가.재화등의 검색 및 선택</li>
                            <li>나.성명, 주소, 전화번호, 전자우편주소(또는 이동전화번호)등의 입력</li>
                            <li>다.약관내용, 청약철회권이 제한되는 서비스, 배송료 및 설치비등의 비용부담과 관련한 내용에 대한 확인</li>
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          ① SCS는 이용자의 주문신청에 대해 다음 각호에 해당하면 승낙하지 않을 수 있습니다. 다만 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면
                          미성년자 본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지해야 합니다.
                          <ul>
                            <li>가.신청내용에 허위, 누락, 오기가 있는 경우</li>
                            <li>나.미성년자가 담배, 주류등 청소년보호법에서 금지하는 재화등을 구매하는 경우</li>
                    ...
                    <li>
                      ...
                      <p>구매한 재화등에 대한 대급지급방법은 다음 각호의 방법중 가용한 방법으로 할 수 있습니다. 단, SCS는 이용자의 지급방법에 대하여 재화등의 대금에 어떠한 명목의
                    ...
                    <li>
                      ...
                      <ol>
                        <li>① SCS는 이용자의 구매신청이 있는 경우 이용자에게 승낙의 의사표시 및 계약내용에 대한 서면 교부(이하 승낙통지라 함)를 이용자가 회원가입시 SCS 에
                          고지한
                          전자우편주소로 송부합니다
                        </li>
                        <li>② 승낙통지를 받은 이용자는 의사표시의 불일치등이 있는 경우에는 승낙통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고 SCS는 배송전에 이용자의
                          요청이 있는 경우에는 지체없이 그 요청에 따라 처리하여야 합니다. 다만, 이미 대금을 지불한 경우에는 제17조의 청약철회 등에 관한 규정에 따릅니다.
                        </li>
                      </ol>
                    </li>
                    <li>
                      ...
                      <ol>
                        <li>① SCS는 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일이내에 재화등을 배송할 수 있도록 주문제작, 포장등
                          기타의 필요한 조치를 취합니다. 단, SCS가 이미 재화등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터 3영업일 이내에 재화등의
                          공급을 위해 필요한 조치를 취합니다. 이때 SCS는 이용자가 재화등의 공급 절차 및 진행사항을 확인할 수 있도록 적절한 조치를 합니다.
                        </li>
                        <li>② SCS는 이용자가 구매한 재화에 대한 배송수단, 수단별 배송비용부담자, 수단별 배송기간등을 명시합니다. 만약 약정 배송기간을 초과한 경우에는 그로 인한
                          이용자의 손해를 배상하여야 합니다. 다만 SCS가 고의, 과실이 없음을 입증한 경우에는 그러하지 아니합니다.
                        </li>
                      </ol>
                    </li>
                    <li>
                      <h5 className="Fh5_tit first" id="article01">제16조 (환급)</h5>
                      <p>SCS는 이용자가 구매신청한 재화등이 품절등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를 이용자에게 통지하고 사전에 재화등의 대금을 받은
                        경우에는
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화등의 내용이 표시,광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화등을 공급받은 날부터
                          3월이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.
                        </li>
                    ...
                    <li>
                      ...
                      <ol>
                        <li>① SCS는 이용자로부터 재화등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화등의 대금을 환급합니다. 이 경우 SCS가 이용자에게 재화등의 환급을 지연한
                          때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.
                        </li>
                        <li>② SCS는 위 대금을 환급함에 있어서 이용자가 신용카드 또는 전자화폐등의 결제수단으로 재화등의 대금을 지급한 때에는 지체없이 당해 결제수단을 제공한 사업자로
                          하여금 재화등의 대금의 청구를 정지 또는 취소하도록 요청합니다.
                        </li>
                        <li>③ 청약철회등의 경우 공급받는 재화등의 반환에 필요한 비용은 이용자가 부담합니다. SCS는 이용자에게 청약철회등을 이유로 위약금 또는 손해배상을 청구하지
                          않습니다. 다만 재화등의 내용이 표시,광고 내용과 다르거나 계약내용과 다르게 이행되어 청약철회등을 하는 경우 재화등의 반환에 필요한 비용은 SCS가 부담합니다.
                        </li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>② SCS에서 재화등을 구입하고 ISP(internet secure payment) 즉 인터넷안전결제 시스템을 채택하지 않은 신용카드로 결제하는 경우,
                          이용자는
                          신용카드번호, 신용카드 비밀번호 2자리, 신용카드 유효기간, 휴대전화번호를 본인확인 및 신용카드 결제를 위해 입력하여야 합니다. SCS는 위 정보를 오직 이용자의
                          본인확인 및 대금결제만을 위해서 이용할 것입니다. 단, SCS은 위 정보를 이용자의 청약철회에 대비하여 1개월동안 보존하며 1개월의 보존기간 경과시 재생할 수
                          없는
                          방법으로 삭제합니다.
                        </li>
                    ...
                    <li>
                      ...
                      <p>이용자 또는 이용자의 법정대리인(이용자가 14세 미만의 어린이일 경우)는 언제나 자신 또는 자신이 보호하는 아동의 개인정보를 열람, 정정하거나 삭제를 요청할 수
                        있으며, 이용자 또는 이용자의 법정대리인으로부터 이러한 요청을 받은 즉시 필요한 조치를 합니다. 이용자 또는 이용자의 법정대리인이 오류의 정정을 요구한 경우 그
                        오류를
                        정정할 때까지 당해 개인정보를 이용하지 않습니다.</p>
                    </li>
                    <li>
                      <h5 className="Fh5_tit first" id="article01">제21조 (개인정보관리책임자 등)</h5>
                      <ul>
                        <li>① SCS는 개인정보보호를 위해 관리자를 한정하며 그 수를 최소화하며 신용카드, 은행계좌등을 포함한 이용자의 개인정보의 분실, 도난, 유출, 변조등으로 인한
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        <li>① SCS는 법령과 본 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 본 약관이 정하는 바에 따라 지속적이고 안정적으로 상품을 제공하는 데 최선을
                          다하여야 합니다.
                        </li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>② 연결 몰은 피연결 몰이 독자적으로 제공하는 재화등에 의하여 이용자와 행하는 거래에 대해서는 보증책임을 지지 않는다는 뜻을 연결 몰의 초기화면 또는 연결되는
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>② 이용자는 SCS를 이용함으로써 얻은 정보 중 SCS나 기타의 저작권자에게 지적재산권이 귀속된 정보를 SCS의 사전 승낙 없이 복제, 송신, 출판, 배포,
                          방송
                    ...
                    <li>
                      ...
                      <p>재화등에 내장되거나 별도로 고객에게 제공되는 일체의 컴퓨터 프로그램은 회사가 당해 프로그램의 소유자와 적법한 라이센스계약등을 통해서 프로그램사용권을 부여 받은
                        것입니다. 이용자는 구입한 재화등의 유기적 일체로서 컴퓨터프로그램을 사용할 수 있으나 이를 별도로 분리하거나 이를 복제, 편집, 제3자에게 임대할 수
                        없습니다.</p>
                    </li>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>② 수리서비스의 제공과 관련하여 고객은 서비스를 제공받기 이전에 재화등의 데이터저장영역에 설치한 소프트웨어를 포함하여 저장된 모든 데이터와 데이터저장영역의
                          내용을
                          백업해야 하고 재화등에 부속한 테이프, CD, 디스켓, 메모리스틱등 데이터가 저장되어 있는 모든 부속물을 제거하여야 합니다. 수리서비스를 제공하는 동안 고객의
                          재화등의 데이터저장영역 내 내용이 소실되거나 재포맷 될 가능성이 많으며 회사는 수리서비스를 제공하는 동안 발생할 수 있는 재화등에 저장되거나 재화등의 부속물에
                          저장된
                          프로그램, 데이터, 기타 정보의 손상, 손실, 분실 및 이로 인해 발생한 손해에 대해서 책임이 없습니다.
                        </li>
                      </ol>
                    </li>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>② SCS의 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그 사항을 처리합니다. 다만, 신속한 처리가 곤란한 경우에는 이용자에게 그 사유와 처리일정을
                          즉시
                          통보해 드립니다.
                        </li>
                        <li>③ SCS와 이용자간에 발생한 전자상거래 분쟁과 관련하여 이용자의 피해구제신청이 있는 경우에는 공정거래위원회 또는 시,도지사가 의뢰하는 분쟁조정기관의 조정에
                          따를
                          수 있습니다.
                        </li>
                      </ol>
                    ...
                    <li>
                      ...
                      <ol>
                        <li>① SCS와 이용자간 발생한 전자상거래 분쟁에 관한 소송은 제소 당시의 이용자의 주소에 의하고 주소가 없는 경우에는 거소를 관할하는 지방법원의 전속관할로
                          합니다.
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        <li>1)수리요금 온라인 결제서비스란 공식 소니 서비스 센터를 통해 수리 받으신 제품의 수리비용을 SCS 사이트를 통해 편리하게 결제 할 수 있는 서비스입니다.
                        </li>
                        ...
                        <li>3)SCS는 이용자의 결제신청에 대해 즉시 확인메일을 보내며 이용자에게 해당 확인메일이 도달한 시점에 온라인 결제서비스 계약이 성립하는 것으로 봅니다.
                        </li>
                      </ol>
                    </li>
                    <li>
                      <h5 className="Fh5_tit first" id="article25">제2조 수신확인 및 결제신청 변경 및 취소</h5>
                      <p>결제신청 확인메일을 받은 이용자는 신청내용과 일치하지 않는 내용 등이 있을 경우 즉시 신청내용 변경 또는 신청 취소를 할 수 있으며 SCS는 배송 전에 이용자의
                        요청이
                        있는 경우에는 지체 없이 그 요청에 따라 처리하여야 합니다. 단, 전자상거래 등에서의 소비자보호에 관한 법률 제18조 제8항 및 제 9항에 따라 이용자의 요청에
                        의하여
                        이미 배송 된 경우에는 배송비 등 SCS이 사용한 비용을 이용자에게 청구할 수 있습니다.</p>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>3)SCS는 제품에 대한 배송 수단, 배송비용 부담자, 수단별 배송기간 등을 명시합니다. 만약 SCS 가 고의 또는 과실로 약정 배송기간을 초과한 경우에는
                          그로
                          인한 이용자의 손해를 배상하여야 합니다. 단, SCS의 고의 또는 과실이 없이 불가항력 또는 제 3자의 고의 또는 과실에 의하여 약정 배송기간을 초과한 경우에는
                          그러하지 아니합니다.
                        </li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>3)SCS는 이용자의 결제신청에 대해 다음 각 호에 해당하지 않는 한 승낙합니다. 가. 신청내용에 허위, 누락, 오기가 있는 경우 나. 결제 신청에 승낙하는
                          것이
                    ...
                    <li>
                      ...
                      <p>온라인 요금결제는 신용카드 및 무통장 입금이 가능하며 자세한 내용은 해당 사이트 https://www.sony.co.kr/scs 의 소니 아카데미를 참조해주십시오.
                        무통장 입금으로 계약을 체결한 이용자는 수신 확인의 통지를 받은 날로부터 다음날 17시 이내로 입금을 해 주어야 합니다. (토,일,공휴일은 제외)</p>
                    </li>
                    <li>
                      <h5 className="Fh5_tit first" id="article25">제3조 결제 신청의 변경, 취소</h5>
                      <p>이용자는 결제신청 확인메일을 받고 신청내용과 일치하지 않는 내용 등이 있을 경우 즉시 신청내용 변경 또는 신청 취소를 할 수 있습니다. 이용자의 신청변경 및 취소는
                        세미나 실시일로부터 2일 전 17시까지 가능하며 강좌 실시일 1일 전 또는 당일 신청의 건은 취소 할 수 없습니다.</p>
                    </li>
                    <li>
                      <h5 className="Fh5_tit first" id="article25">제4조 철회에 대한 효과</h5>
                      <p>SCS는 소니 아카데미에 지불한 대금은 취소 신청 후 영업일 3일 이내에 지급받은 재화 등의 대금을 환급합니다. (토,일,공휴일은 제외) 재화등의 환급을 지연한
                        때에는
                        그 지연기간에 대하여 공정거래 위원회가 정하여 고시하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.</p>
                      <p>SCS 는 위 대금을 환급함에 있어서 이용자가 신용카드 또는 전자화폐등의 결제수단으로 재화등의 대금을 지급한 때에는 지체없이 당해 결제수단을 제공하는 사업자로
                        하여금
                        재화 등의 대금의 청구를 정지 또는 취소하도록 요청합니다.</p>
                    </li>
                    <li>
