  ...
  <div className="content employee">
    <div className="event_header">
      <div className="event_header_inner">
        <h1 className="event_header_title">ASC몰</h1>
        <p className="event_header_desc">ASC 임직원을 위한 소니 ASC몰에서<br />다양한 제품을 더욱 특별한 가격으로 만나보세요</p>
        <div className="event_header_link"><a href="javascript:openModal('popup_empolyee');" data-modal-target="popup_empolyee">ASC 이용규정</a></div>
      </div>
    </div>
