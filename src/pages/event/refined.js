          ...
          <div className="content employee">
            <div className="event_header">
              <div className="event_header_inner refined">
                ...
                <p className="event_header_desc">
                  제품을 구입하신 고객님들께 감사의 마음을 담아
                  <br />
                  소니 제품을 특별한 가격으로 구매하실 수 있는 혜택을 드립니다.
                </p>
              </div>
            </div>
                ...
                <div className="event_prd_list">
                  <div className="product">
                    ...
                    <div className="product_name">
                      <a href="#" className="product_name_title">
                        SRS-XP500 (1+1)
                      </a>
                      <p className="product_name_desc">
                        4K HDR(HLG), Fast Hybrid AF가 탑재된 전문가급 1인치
                        핸디캠4K HDR(HLG), Fast Hybrid AF가 탑재된 전문가급
                        1인치 핸디캠4K HDR(HLG), Fast Hybrid AF가 탑재된
                        전문가급 1인치 핸디캠
                      </p>
                      <div className="product_name_price">
                        <div className="original">
                          179,000 <span className="unit">원</span>
                        </div>
                        <div className="sale">
                          159,000 <span className="unit">원</span>
                        </div>
                      </div>
                  ...
                  <div className="product">
                    ...
                    <div className="product_name">
                      ...
                      <p className="product_name_desc">
                        4K HDR(HLG), Fast Hybrid AF가 탑재된 전문가급 1인
                      </p>
                      <div className="product_name_price">
                        <div className="original">
                          179,000 <span className="unit">원</span>
                      ...
                      <div className="product_btn_wrap">
                        ...
                        <button
                          type="button"
                          className="button button_primary button-s"
                        >
                          예약 구매
                        </button>
                      </div>
