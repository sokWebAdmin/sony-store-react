              ...
              <div className="scroll_inner">
                <div className="foot_cont">
                  <ul>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li className="mt">7) 제품 보증기간<br/>
                          ...
                          href="http://scs.sony.co.kr" target="_blank" title="새창열림">http://scs.sony.co.kr</a>) 참조]
                          단, B,C 등급 제품의 경우 이쿠폰 발행은 적용되지 않으며, 연장서비스플랜 구매가 불가합니다.
                          A급 제품의 경우 연장서비스플랜 구매는 가능하며, 이쿠폰은 발행되지 않습니다.
                        </li>
                    ...
                    <li>
                      <h5 className="Fh5_tit">4. 시판구입시 주의사항</h5>
                      <ol>
                        <li>1) 반품<br/>
