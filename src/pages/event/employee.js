  ...
  <div className="content employee">
    <div className="event_header">
      <div className="event_header_inner">
        <h1 className="event_header_title">임직원몰</h1>
        <p className="event_header_desc">소니코리아 및 관계사 임직원을 위한 소니 임직원몰에서<br />다양한 제품을 더욱 특별한 가격으로 만나보세요</p>
        <div className="event_header_link"><a href="javascript:openModal('popup_empolyee');" data-modal-target="popup_empolyee">임직원몰 이용규정</a></div>
      </div>
    </div>
