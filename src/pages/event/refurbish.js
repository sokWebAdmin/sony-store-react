          ...
          <div className="content employee">
            <div className="event_header">
              <div className="event_header_inner refurbish">
                ...
                <p className="event_header_desc">리퍼비시란? 전시품, 반품, 기타 사유로 새 제품으로 판매하기 어려운 제품을 <span className="block">내부 절차를 거쳐 합리적인 가격으로 재판매하는 것입니다.</span>
                </p>
                <div className="event_header_link"><a href="javascript:openModal('popup_refurbish');"
                                                      data-modal-target="popup_refurbish">리퍼비시 제품 구매시 유의사항</a></div>
              </div>
            </div>
            <div className="event_tablist">
              <div className="tab_ui scroll"
                   data-scroll-view={5}>{/* 스크롤탭 : class: scroll / data-scroll-view 보여지는 탭 수 */}
                <ul>
