        ...
        <div className="order_info">
          ...
          <div className="order_left">
            <div className="acc acc_ui_zone">
              ...
              <div className="acc_item on">
                ...
                <div className="acc_inner">
                  <div className="acc_box">
                    ...
                    <div className="acc_form">
                      <div className="acc_cell vat">
                        <label htmlFor="deliver_name">수령인 이름<i className="necessary" /></label>
                      </div>
                      <div className="acc_cell">
                        <div className="acc_group parent error">{/* error 문구 제어 */}
                          <div className="acc_inp type3">
                            <input type="text" className="inp" id="deliver_name" placeholder="이름을 입력하세요." />
                            <span className="focus_bg" />
                          </div>
                          <p className="error_txt"><span className="ico" />이름을 입력해 주세요.</p>
                        </div>
                      ...
                      <div className="acc_cell">
                        <div className="acc_group parent error">{/* error 문구 제어 */}
                          <div className="acc_inp type4">
                            <input type="text" className="inp" id="user_address" placeholder="주소를 입력하세요." />
                            <span className="focus_bg" />
                        ...
                        <div className="acc_group parent error">{/* error 문구 제어 */}
                          <div className="acc_inp type5">
                            <input type="text" className="inp" placeholder="상세 주소를 입력하세요." />
                            <span className="focus_bg" />
                          </div>
              ...
              <div className="acc_item on">
                <div className="acc_head">
                  <a href="#" className="acc_btn" title="비밀번호 설정 열기">
                    <span className="acc_tit">비밀번호 설정</span>
                    <span className="acc_arrow">상세 보기</span>
                  </a>
                </div>
                <div className="acc_inner">
                  <div className="acc_box">
                    ...
                    <div className="acc_form">
                      ...
                      <div className="acc_cell">
                        <div className="acc_group parent">
                          <div className="acc_inp type3">{/* input widtht type1~ 클래스 제어 */}
