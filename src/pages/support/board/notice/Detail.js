                ...
                <div className="notice_detail_inner">
                  <div className="notice_cont_tit">
                    <p className="notice_date">
                      등록일<span className="val">{registerYmdt?.substring(0, 10)}</span>
                    </p>
                    <p className="notice_pv">
                      조회수<span className="val">{viewCnt}</span>
                    </p>
                  </div>
                  <div className="notice_cont" dangerouslySetInnerHTML={{ __html: content }}></div>
                  <div className="btn_article">
                    <Link to="/notice" className="button button_positive" type="button">
                      목록
                    </Link>
                  </div>
                </div>
