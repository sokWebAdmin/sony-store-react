...
const Benefit = (props) => {
    const [tabState, setTabState] = useState(
        props.location?.state?.type || 'mileage',
    );
    useEffect(
        () => setTabState(props.location?.state?.type || 'mileage'),
                    ...
                    <div className='membership'>
                        ...
                        >
                            ...
                            <div className='detail_veiw_area tab_ui_info'>
                                {/* 마일리지 */}
                                <div
                                    className={`tab_ui_inner ${
                                        tabState === 'mileage' && 'view'
                                    } temp`}
                                >
                                    <div className='mileage_info'>
                                        <div className='mileage_info_inner'>
                                            <strong className='mileage_info_inner_tit'>
                                                마일리지 안내
                                            </strong>
                                        ...
                                        <div className='col_table'>
                                            ...
                                            <div className='col_table_body'>
                                                <div className='col_table_row'>
                                                    ...
                                                    <div className='col_table_cell'>
                                                        <img
                                                            src='../../images/membership/membership_vip2.svg'
                                                            alt='vip'
                                                        />
                                                    </div>
                                                    <div className='col_table_cell'>
                                                        <img
                                                            src='../../images/membership/membership_family2.svg'
                                                            alt='membership'
                                                        />
                                                    </div>
                                                </div>
                                ...
                                <div
                                    className={`tab_ui_inner ${
                                        tabState === 'premium' && 'view'
                                    }`}
                                >
                                    <div className='prmm_smry'>
                                        <h2 className='prmm_smry_title'>
                                            프리미엄 서비스란?
                                        </h2>
                                        ...
                                        <ul className='prmm_dtl_lists'>
                                            ...
                                            <li className='prmm_dtl_list'>
                                                ...
                                                <a
                                                    href={
                                                        ...
                                                        'www.sony.co.kr/scs/handler/Service-Media'
                                                    }
                                            ...
                                            <li className='prmm_dtl_list'>
                                                ...
                                                <a
                                                    href={
                                                        window.anchorProtocol +
                                                        'www.sony.co.kr/scs/handler/SCSWarranty-ESPOrderConfirm'
                                                    }
                                                    onClick={window.openBrowser}
                                                    className='prmm_dtl_link'
                                                    target='_blank'
                                                    ...
                                                    <div className='coupon'>
                                                        ...
                                                        <ul className='coupon_desc'>
                                                            <li className='lists'>
                                                                ...
                                                                <p className='lists_txt'>
                                                                    카오디오/디지털카메라/카메라
                                                                    바디(별매렌즈)/캠코더/워크맨(MP3플레이어)/헤드폰/이어폰/스피커/홈오디오
                                                                    등
                                                                </p>
                                                            </li>
                                                            <li className='lists'>
