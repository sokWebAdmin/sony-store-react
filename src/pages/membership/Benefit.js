            ...
            <div className="membership_kvarea temp">
              <div className="membership_kvarea_titlebox">
                ...
                <div className="line_box">
                  <p className="txt">
                    소니스토어 온라인 구매 시{' '}
                    <strong className="amp">
                      금액대 관계 없이 모두 <span>무</span>
                      <span>료</span>
                      <span>배</span>
                      <span>송!</span>
                    </strong>
              ...
              <div className="detail_veiw_area tab_ui_info">
                ...
                <div className={`tab_ui_inner ${tabState === 'mileage' && 'view'} temp`}>
                  <div className="mileage_info">
                    <div className="mileage_info_inner">
                      ...
                      <p className="mileage_info_inner_txt">
                        * 단, ESP, Playstation 제품 및 일부 상품은 마일리지가 적립 되지 않습니다.
                        <br />
                        쿠폰 및 마일리지 사용 시, 쿠폰 및 마일리지 사용 금액을 제외한 결제 금액만 적립됩니다.
                      </p>
                    </div>
                  </div>
                  {/* <!-- pc table --> */}
                    ...
                    <div className="col_table">
                      ...
                      <div className="col_table_body">
                        ...
                        <div className="col_table_row">
                          ...
                          <div className="col_table_cell">
                            구매금액(누적)이 <strong className="emp">200만원 이상</strong>이 되는 시점 익일부터 VIP 혜택
                            2년 간 적용
                          </div>
                          <div className="col_table_cell">
                            구매금액(누적)이 <strong className="emp">200만원 미만</strong>시 익일부터 MEMBERSHIP 혜택
                            2년 간 적용
                          </div>
                        </div>
                        <div className="col_table_row">
                    ...
                    <table className="common__table" role="presentation">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <p className="benefit">
                              구매 금액(누적)이 <strong>200만원 이상</strong>이 되는 시점 익일부터 VIP 혜택 2년 간 적용
                            </p>
                            <p className="benefit">
                              제품 구매 시 결제 금액의 <strong>4%</strong> 적립
                            </p>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <p className="benefit">
                              구매 금액(누적)이 <strong>200만원 미만</strong>시 익일부터 MEMBERSHIP 혜택이 2년 간 적용
                            </p>
                            <p className="benefit">
                              제품 구매 시 결제 금액의 <strong>2%</strong> 적립
                            </p>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <div className="mileage_bgarea_inner">
                      ...
                      <div className="message">
                        <div className="message_lft">
                          ...
                          <div className="message_txt">
                            <p>
                              제 마일리지가 얼마 있는지 확인해보고 <span className="br">싶어요 !</span>
                            </p>
                          </div>
                        </div>
                        <div className="message_rgt">
                          <div className="message_txt">
                            <p>
                              안녕하세요, 소니스토어 회원님 <span className="emoticon"></span>
                            </p>
                          </div>
                          <div className="message_txt">
                            <p>
                              마일리지는 로그인 후 <em className="empcolor">[마이페이지 &gt;</em>
                              <span className="br">
                                <em className="empcolor">마일리지]</em> 탭에서 확인하실 수 있습니다.
                              </span>
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="mileage_use">
                    <div className="mileage_use_txt">
                      <p>
                        소니스토어 온라인 및 소니코리아 고객지원을 통한 구매 시에는 제품 수령일자 기준으로{' '}
                      ...
                      <p>
                        ...
                        <span className="br">(2011년 8월 9일 이후 적립 마일리지부터 적용)</span>
                      </p>
                    </div>
                    <div className="mileage_use_method">
                      ...
                      <ul className="mileage_use_method_list">
                        ...
                        <li className="method_02">
                          소니 공식 서비스센터
                          <span className="m_br">
                            에서 <span className="br">제품 수리 및 컨텐츠 이용 시</span>
                          </span>
                        </li>
                      </ul>
                      <div className="mileage_use_method_txt">
                        <p>
                          <strong>1마일리지는 1원</strong>으로 환산되며, <strong>5,000마일리지</strong>부터 현금처럼
                          사용하실 수 있습니다.
                        </p>
                ...
                <div className={`tab_ui_inner ${tabState === 'premium' && 'view'}`}>
                  <div className="prmm_smry">
                    ...
                    <p className="prmm_smry_desc">
                      고객님께서 소니제품을 구입하거나 사용 시에 보다 편리하게 사용하실
                      <br /> 수 있도록 제공해 드리는{' '}
                      <strong className="primary-color">소니스토어만의 특별한 서비스</strong>입니다.
                    </p>
                    <ul className="prmm_smry_lists">
                      <li className="prmm_smry_list">
                        기프트<h3 className="prmm_smry_item">선물하기 서비스</h3>
                      </li>
                      <li className="prmm_smry_list">
                        운송
                      ...
                      <li className="prmm_smry_list">
                        비디오<h3 className="prmm_smry_item">영상 변환 서비스</h3>
                      </li>
                      <li className="prmm_smry_list">
                        수리<h3 className="prmm_smry_item">연장 서비스 플랜</h3>
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul className="prmm_dtl_lists">
                      <li className="prmm_dtl_list">
                        <div className="prmm_dtl_pic">
                          <img
                            src="../../images/membership/premium1.jpg"
                            alt="선물하기 서비스"
                            className="prmm_dtl_img"
                          />
                        </div>
                        <h3 className="prmm_dtl_title">선물하기 서비스</h3>
                        <ul className="prmm_dtl_prctns">
                          <li className="prmm_dtl_prctn">
                            선물하기 서비스는 <strong className="primary-color">소니스토어 회원만</strong> 온라인 또는
                            앱에서 이용가능한 서비스입니다.
                          </li>
                          <li className="prmm_dtl_prctn">
                            선물하기 서비스는 <strong className="primary-color">제품 1건의 구매</strong>(결제건)에 한해
                            이용이 가능합니다.
                          </li>
                        </ul>
                      ...
                      <li className="prmm_dtl_list">
                        <div className="prmm_dtl_pic">
                          <img
                            src="../../images/membership/premium2.jpg"
                            alt="택배/퀵/친환경 서비스"
                            className="prmm_dtl_img"
                          />
                        </div>
                        ...
                        <ul className="prmm_dtl_prctns">
                          <li className="prmm_dtl_prctn">
                            소니스토어에서는 온라인 주문 한정으로 친환경 패키징을 제공합니다.
                          </li>
                          <li className="prmm_dtl_prctn">
                            박스/완충 포장재/테이프 모두 종이를 사용하여 환경 보호에 기여합니다.
                          </li>
                          <li className="prmm_dtl_prctn">
                            퀵 서비스는 소니스토어에서 구매한 제품에 한하여, 제품 가격에 따라 배송 비용이 할증될 수
                            있습니다.
                          </li>
                          {/* <li className="prmm_dtl_prctn">제품 운송 중 파손/분실되는 경우에 이용 가능하며, 국내 지원만 가능합니다.</li> */}
                          <li className="prmm_dtl_prctn">
                            구매 금액이 <strong className="primary-color">5만원 이상</strong>인 경우에 이용 가능하며,
                            국내 지역만 가능합니다.
                          </li>
                          <li className="prmm_dtl_prctn">
                            퀵 서비스 : 구매금액이 <strong className="primary-color">200만원 이상</strong>인 경우에 이용
                            가능하며, 서울 지역에서만 가능합니다.
                          </li>
                        </ul>
                      ...
                      <li className="prmm_dtl_list">
                        <div className="prmm_dtl_pic">
                          <img
                            src="../../images/membership/premium3.jpg"
                            alt="영상변환 서비스"
                            className="prmm_dtl_img"
                          />
                        </div>
                        ...
                        <ul className="prmm_dtl_prctns">
                          <li className="prmm_dtl_prctn">
                            영상변환 서비스는 고객님께서 소장하고 계시는 비디오 테이프를{' '}
                            <strong className="primary-color">USB 메모리 또는 DVD 디스크</strong>로 변환하여 드리는
                            서비스입니다.
                          </li>
                          <li className="prmm_dtl_prctn">
                            변환 가능한 테이프는 <strong className="primary-color">6mm, 8mm 또는 VHS 테이프</strong>
                            이며, 가까운 서비스 센터로 비디오 테이프를 가지고 방문하시면 변환 서비스를 받으실 수
                            있습니다.
                          </li>
                        </ul>
                        <a
                      ...
                      <li className="prmm_dtl_list">
                        <div className="prmm_dtl_pic">
                          <img
                            src="../../images/membership/premium4.jpg"
                            alt="연장 서비스 플랜"
                            className="prmm_dtl_img"
                          />
                        </div>
                        ...
                        <ul className="prmm_dtl_prctns">
                          <li className="prmm_dtl_prctn">
                            연장 서비스 플랜은 소정의 비용으로 제품 구입일로부터 2년 또는 3년 동안 횟수와 금액 상관 없이
                            안심하고 무상 수리를 받을 수 있는 프리미엄 서비스입니다.
                          </li>
                          <li className="prmm_dtl_prctn">소니스토어 온라인 및 전화주문을 통해서 구매 가능합니다.</li>
                          <li className="prmm_dtl_prctn">
                            연장 서비스 플랜 적용은{' '}
                            <strong className="primary-color">상품 구매일로부터 7일 이후</strong> 자동 적용됩니다.
                          </li>
                          <li className="prmm_dtl_prctn">
                            연장 서비스 플랜 상품은 <strong className="primary-color">무형 상품</strong>으로 별도
                            배송되지 않습니다.
                          </li>
                        </ul>
                        <a
                    ...
                    <div className="coupon_inner">
                      <div className="coupon_list">
                        <div className="coupon_box">
                          <span className="coupon_type two">
                            ALL
                            <br /> COUPON
                          </span>
                            ...
                            <ul className="coupon_desc">
                              <li className="lists">
                                ...
                                <p className="lists_txt">
                                  소니스토어 전 제품 (단, ESP 및 Playstation 및 관련 제품 제외)
                                </p>
                              </li>
                              <li className="lists">
                                ...
                                <p className="lists_txt">
                                  3만원 이상의 소니스토어 전 제품
                                  <br />
                                  (단, ESP 및 Playstation 및 관련 제품 제외)
                                </p>
                              </li>
                              <li className="lists">
