          ...
          <div className="app_layer app_layer_full">
            ...
            <div className="terms">
              <div className="foot_box">
                ...
                <a href={window.anchorProtocol + "//www.apache.org/licenses/"} onClick={window.openBrowser} target="_blank"
                   className="link_opensourcelicense">http://www.apache.org/licenses/</a>
                <p>TERMS AND CONDITIONS FOR USE, REPRODUCTION, AND DISTRIBUTION</p>

                <div className="foot_cont">
                  <h2 className="Fh4_tit">1. Definitions.</h2>
                  ...
                  <p>"You" (or "Your") shall mean an individual or Legal Entity exercising permissions granted by this
                    License.</p>
                  ...
                  <p>"Work" shall mean the work of authorship, whether in Source or Object form, made available under
                  ...
                  <p>"Derivative Works" shall mean any work, whether in Source or Object form, that is based on (or
                    ...
                    bind by name) to the interfaces of, the Work and Derivative Works thereof.</p>
                  <p>"Contribution" shall mean any work of authorship, including the original version of the Work and
                  ...
                  <p>"Contributor" shall mean Licensor and any individual or Legal Entity on behalf of whom a
                    Contribution has been received by Licensor and subsequently incorporated within the Work.</p>
                </div>

                <div className="foot_cont">
                  <h2 className="Fh4_tit">2. Grant of Copyright License.</h2>
                ...
                <div className="foot_cont">
                  <h2 className="Fh4_tit">3. Grant of Patent License.</h2>
                  <p>Subject to the terms and conditions of this License, each Contributor hereby grants to You a
                ...
                <div className="foot_cont">
                  <h2 className="Fh4_tit">4. Redistribution.</h2>
                  <p>You may reproduce and distribute copies of the Work or Derivative Works thereof in any medium, with
                    or without modifications, and in Source or Object form, provided that You meet the following
                    conditions:</p>
                  <ul>
                    <li>1. You must give any other recipients of the Work or Derivative Works a copy of this License;
                      and
                    </li>
                    <li>2. You must cause any modified files to carry prominent notices stating that You changed the
                      files; and
                    </li>
                    <li>3. You must retain, in the Source form of any Derivative Works that You distribute, all
                    ...
                    <li>4. If the Work includes a "NOTICE" text file as part of its distribution, then any Derivative
                      ...
                      additional attribution notices cannot be construed as modifying the License.<br /><br />You may
                      add
                      Your own copyright statement to Your modifications and may provide additional or different
                      license terms and conditions for use, reproduction, or distribution of Your modifications, or
                      for any such Derivative Works as a whole, provided Your use, reproduction, and distribution of
                ...
                <div className="foot_cont">
                  <h2 className="Fh4_tit">5. Submission of Contributions.</h2>
                  <p>Unless You explicitly state otherwise, any Contribution intentionally submitted for inclusion in
                    the Work by You to the Licensor shall be under the terms and conditions of this License, without any
                ...
                <div className="foot_cont">
                  <h2 className="Fh4_tit">6. Trademarks.</h2>
                ...
                <div className="foot_cont">
                  <h2 className="Fh4_tit">7. Disclaimer of Warranty.</h2>
                ...
                <div className="foot_cont">
                  <h2 className="Fh4_tit">8. Limitation of Liability.</h2>
                ...
                <div className="foot_cont">
                  <h2 className="Fh4_tit">9. Accepting Warranty or Additional Liability.</h2>
                  <p>While redistributing the Work or Derivative Works thereof, You may choose to offer, and charge a
                ...
                <div className="foot_cont">
                  <h2 className="Fh4_tit">APPENDIX: HOW TO APPLY THE APACHE LICENSE TO YOUR WORK</h2>
                  <p>To apply the Apache License to your work, attach the following boilerplate notice, with the fields
                    ...
                    page" as the copyright notice for easier identification within third-party archives.</p>
                </div>

                <div className="caution_box">
                  <p>Copyright [2021] [© Sony Korea Corporation]</p>
                  ...
                  <p><a href={window.anchorProtocol + 'www.apache.org/licenses/LICENSE-2.0'} onClick={window.openBrowser} target="_blank"
