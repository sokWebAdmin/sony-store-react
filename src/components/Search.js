  ...
  return (
    <>
      ...
      <div className="search" style={{ display: 'block' }}>
          ...
          <div className="search__field">
            <form onSubmit={(e) => searchHandler(e, keyword)}>
              ...
              <fieldset>
                ...
                />
                <button className="btn search__btn__submit" onClick={(e) => searchHandler(e, keyword)}>
                    ...
                    <Link to={`/product-view/${rp.productNo}`} onClick={() => setSearchOpen(false)}>
                      <div className="search__recomm__pic">
                        ...
                        {rp.stickerLabels?.map((l, idx) => (
                          <span key={`${l}${idx}`} className="badge__text" style={{ color: tagColorMap[l] }}>
                            {l}
                          </span>
                        ))}
                      </div>
        ...
        <button className="btn search__btn__close" onClick={() => setSearchOpen(false)}>
