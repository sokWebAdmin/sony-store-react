...
export default function OrderListLinkBox() {
  return (
    <div className="ico_box_link">
      <a href={window.anchorProtocol + "www.sony.co.kr/electronics/support"} className="box_link_inner ico_type3" target="_blank" onClick={window.openBrowser}>
      ...
      <Link to="/my-page/old-order-list" className="box_link_inner ico_type4">
        <div className="txt_box">
          <p className="tit">2021년 11월 이전 주문 내역</p>
