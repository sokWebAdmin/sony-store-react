...
const MemberSummary = ({ tabChange, profile, availablemileage, wishCount, memberName }) => {
    ...
    <div className="my_user">
      <div className="user_profile">
        <p className="user_name">
          <span className="name">{memberName || ''}</span>님 안녕하세요 :)
        </p>
      ...
      <div className="user_info">
        <ul>
          <li className="user_item grade">
            <Link to="/membership/benefit" className="user_tabs">
              ...
              <span className="val_txt">
                <span className={`val ${grade?.className}`}>{grade?.label || ''}</span>
              </span>
            </Link>
          </li>
          <li className="user_item mileage">
            <a href="#mileage-tit" className="user_tabs" onClick={() => tabChange('mileage')}>
              <span className="ico_txt">
                <span className="txt_arrow">마일리지</span>
              </span>
              <span className="val_txt">
                <span className="val">{toCurrencyString(availablemileage)}</span>M
              </span>
            </a>
          </li>
          <li className="user_item coupon">
            <a href="#coupon-tit" className="user_tabs" onClick={() => tabChange('coupon')}>
              <span className="ico_txt">
          ...
          <li className="user_item like">
            <a href="#wish-tit" className="user_tabs" onClick={() => tabChange('wish')}>
              <span className="ico_txt">
