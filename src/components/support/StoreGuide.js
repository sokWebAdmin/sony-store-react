        ...
        {size.width < 1199 ? (
          ...
          >
            ...
            <SwiperSlide className="swiper-slide box search">
              <a href={window.anchorProtocol + "www.sony.co.kr/scs/handler/Service-AsCenter"} onClick={window.openBrowser} target="_blank" rel="noreferrer">
                <i className="icon"></i>
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide box search">
              <a href={window.anchorProtocol + "www.sony.co.kr/scs/handler/Service-AsCenter"} target="_blank" onClick={window.openBrowser} rel="noreferrer">
                <i className="icon"></i>
                <p className="box_desc">AS 센터 찾기</p>
              </a>
            </div>
