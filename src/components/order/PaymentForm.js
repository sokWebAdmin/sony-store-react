                ...
                <div className="bg_recipe_box">
                  ...
                  <div className="sgic_box_radio acc_radio">
                    <div className="radio_box">
                      <input type="radio" className="inp_radio" id="sgic_tab_radio1" name="sgictabradio" />
                      <label htmlFor="sgic_tab_radio1" className="contentType">신청함</label>
                    </div>
                    <div className="radio_box">
                      <input type="radio" className="inp_radio" id="sgic_tab_radio2" name="sgictabradio" defaultChecked="checked" />
                  ...
                  <div className="sgic_box_result_cont sgic_tab_radio1 on">
                            ...
                            <ul className="select_opt">
                              <li>
                                <a href="#" className="opt_list">
                                  <div className="item">1990</div>
                                </a>
                              </li>
                              <li>
                                <a href="#" className="opt_list">
                                  <div className="item">1991</div>
                                </a>
                              </li>
                            </ul>
                          </div>
                    ...
                    <div className="acc_form">
                      ...
                      <div className="acc_cell parent">
                        <div className="acc_radio">
                          <div className="radio_box">
                            <input type="radio" className="inp_radio" id="sgic_agree_radio1" name="sgicagree" />
                    ...
                    <div className="sgic_noti">
                      ...
                      <ul className="list_dot">
                        ...
                        <li>본 전자보증을 신청하시면 물품대금 결제 시에 소비자에게 서울보증보험의 쇼핑몰보증보험 계약 체결서를 인터넷상으로 자동 발급하여, 인터넷 쇼핑몰에서 발행할 수 있는 소비자 피해를 서울보증보험㈜가 보상하는 서비스 입니다.</li>
                        ...
                        <li>보증보험 전자보증서에 대한 보다 상세한 사항은&nbsp;<a href="http://www.usafe.co.kr/u_esafe.asp" target="_blank" className="under_line"><em className="color">여기</em></a>를 클릭하여 주시기 바랍니다.</li>
                      </ul>
