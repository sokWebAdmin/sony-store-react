...
import InvoiceGuide from 'components/popup/InvoiceGuide';
import InvoicePublish from 'components/popup/InvoicePublish';
                    ...
                    <div className='tabResult'>
                        {payment.payType !== 'VIRTUAL_ACCOUNT' && (
                            <div className='result_cont radio_tab1 on'>
                                ...
                                <ul className='list_dot'>
                                    <li>
                                        무이자 할부 개월 수가 다른 제품을
                                        한꺼번에 결제하면 할부 개월 수가 낮은
                                        제품을 기준으로 할부가 됩니다.
                                    </li>
                                    <li>
                                        무이자 할부 개월 수가 다른 제품을 따로
                                        결제하면 해당 제품에 적용된 무이자 할부
                                        혜택을 받으실 수 없습니다.
                                    </li>
                                </ul>
                            </div>
                        ...
                        {payment.payType === 'VIRTUAL_ACCOUNT' && (
                            <div className='result_cont radio_tab2 on'>
                                    ...
                                    <div className='btn_recipe_box'>
                                        ...
                                        {viewInvoicePublish && (
                                            <InvoicePublish
                                                ...
                                                close={() =>
                                                    setViewInvoicePublish(false)
                                                }
                                            />
                                        )}
                                    </div>
                                    <div className='cash_box'>
                                        <strong className='cash_box_tit'>
                                            현금영수증 발행
                                        </strong>
                                ...
                                <strong className='info_tit3'>
                                    [소비자 피해보상보험 서비스 안내]
                                </strong>
                                <ul className='list_dot'>
                                    <li>
                                        고객님은 안전거래를 위해 현금 결제 시
                                        소니스토어가 가입한 구매안전서비스
                                        소비자피해보상보험서비스를 이용하실 수
                                        있습니다.
                                    </li>
                                    <li>
                                        보상대상 : 미배송, 반송/환불거부,
                        ...
                        <div className='result_cont radio_tab3'>
                            ...
                            <ul className='list_dot'>
                                <li>
                                    무이자 할부 개월 수가 다른 제품을 한꺼번에
                                    결제하면 할부 개월 수가 낮은 제품을 기준으로
                                    할부가 됩니다.
                                </li>
                                <li>
                                    무이자 할부 개월 수가 다른 제품을 따로
