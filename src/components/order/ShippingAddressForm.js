...
const ShippingAddressForm = forwardRef((prop, ref) => {
  ...
  const [pickRecentAddressesVisible, setPickRecentAddressesVisible] = useState(false);
  ...
  useEffect(
    () =>
      specifyDelivery
        ? handleShippingChangeParameter('requestShippingDate', getStrYMDHMSS(specifyDeliveryDate)?.substr(0, 10))
  ...
  const bindReceiverAddress = (selectedAddress) => {
    ...
    Object.entries(receiverAddressMap).forEach(([from, to]) => setObjectState(to, selectedAddress[from])(setShipping));
          ...
          <div className="acc_cell">
            <div className="acc_group parent">
              <div className="acc_inp type4">
                <p className="delivery_txt">{shipping.addressName ? shipping.addressName : '배송지를 선택하세요.'}</p>
                <div className="delivery_btn_box">
                  ...
                  {pickRecentAddressesVisible && (
                    <PickRecentAddresses
                      ...
                      close={() => setPickRecentAddressesVisible(false)}
                    />
                  )}
                </div>
              </div>
          ...
          <div className="acc_group parent">
            <div className="acc_inp type4">
              ...
              <div className="delivery_btn_box type1">
                ...
                {findAddressVisible && (
                  <FindAddress setVisible={setFindAddressVisible} setAddress={bindReceiverAddress} />
                )}
              </div>
              <p className="error_txt">
                <span className="ico" />
      ...
      <div className="acc_form" style={{ height: '423px' }}>
        ...
        <div className="acc_cell vat">
            ...
            <div className="acc_inp">
              <div className="acc_radio">
                <div className="radio_box">
                  ...
                  />
                  <label htmlFor="delivery_radio1" className="contentType">
                    정상 배송
                  </label>
                </div>
                <div className="radio_box">
                  <input
                    ...
                    name="deliveryRadio"
                  />
                  <label htmlFor="delivery_radio2" className="contentType">
                    출고일 지정
                  </label>
                </div>
              </div>
          ...
          <ul className="list_dot">
            ...
            <li>
              출고일 지정 배송의 경우 주문 날짜의 3일 후부터 선택이 가능하며,
              <br />
              지정된 출고일에 맞춰서 제품이 발송되고, 출고일 기준 2~3일 이내 수령이 가능합니다.
            </li>
            <li>소니스토어의 모든 제품은 무료 배송 입니다.</li>
            <li>
              배송기간은 서울, 경기일 경우 2~3일(주문일 포함), 기타 지역은 3~5일 정도 걸립니다.
              <br />
              (정오(낮12시) 이전 결제완료 기준)
            </li>
