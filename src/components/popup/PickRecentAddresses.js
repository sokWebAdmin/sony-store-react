  ...
  return (
    <LayerPopup size={'m'} popContClassName={`shipping_addr ${isMobile && 'scrollH'}`} onClose={close}>
                  ...
                  <div className="chk_select_item label_click">
                    <div className="radio_box radio_only chk_select">
                      <input
                        ...
                        onChange={() => setPickAddressNo(address.addressNo)}
                      />
                      <label htmlFor={address.addressNo} className="contentType"></label>
                    </div>
      ...
      <div className="btn_article">
        <button className="button button_positive button-m" type="button" onClick={submit}>
          확인
        </button>
      </div>
    </LayerPopup>
