...
const EstimateSheet = ({ close, products }) => {
  ...
  return (
    <>
      <div className="layer_mask" style={{ display: 'block' }}></div>
      <div className="popup_wrap size_l estimate" style={{ display: 'block' }} tabIndex="0">
                ...
                <div className="pop_cont_scroll" style={{ height: '303px' }}>
                  <div className="simplified_info">
                    <div className="simplified_estimate">
                      ...
                      <p className="tit">
                        <strong>소니코리아 고객님 귀하,</strong>
                        <br /> 아래와 같이 견적합니다.
                      </p>
                      <div className="estimate_price">
                        <span className="txt">견적금액 :</span>
                        <span className="price_txt">
                          <strong className="price">{toCurrencyString(totalAmt)}</strong> 원
                        </span>
                    ...
                    <div className="estimate_corp">
                      <ul className="corp_list">
                        <li className="name">
                          <strong>소니코리아 주식회사</strong>
                        </li>
                        <li className="addr">
                          서울특별시 영등포구 여의도동 국제금융로
                          <br />
                          10 원아이에프씨 24F (우)150-876
                        </li>
                  ...
                  <div className="estimate_detail">
                    <div className="all_table_wrap">
                      <p className="s_txt_right">* 아래 견적 금액은 구매 시점에 따라 변동될 수 있습니다.</p>
                      <div className="col_table_wrap order_list">
                        ...
                        <div className="col_table_foot">
                          <div className="prd_summary">
                            <p className="prd_total_price">
                              최종 합계 금액{' '}
                              <strong className="prd_summary_price">
                                {toCurrencyString(totalAmt)}
                        ...
                        <p className="sign_txt">
                          <span className="orderer">주문자:</span>
                          <span className="name"></span>
                          <span className="sign">(서명)</span>
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="btn_article">
          <button className="button button_negative button-m closed" type="button" onClick={close}>
            취소
          </button>
          <button onClick={() => onPrint()} className="button button_positive button-m print" type="button">
            프린트
          </button>
        </div>
      </div>
