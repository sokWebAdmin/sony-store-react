...
const filterProductsByGrade = (event, isGrade) =>
    event?.section
...
const EventProducts = ({
    ...
    const _getOrderSheetNo = async (
        productNo = orderProductNo,
    ...
    const hsValidation = async (validation) =>
        await hsValidator.current.validation(validation);
                ...
                <div className='product_name'>
                    ...
                    <div className='product_btn_wrap'>
                        <button
                            ...
                            onClick={() =>
                                history.push(
                                    `/product-view/${product.productNo}`,
                                )
                            }
                        >
                        ...
                        <button
                            ...
                            onClick={() =>
                                goOrder(product.productNo, product.hsCode)
                            }
                            disabled={isSoldOut}
                        >
    ...
    const saleStatus = (p) =>
        getSaleStatus(
            { saleStatusType: p.saleStatusType },
            p.reservationData,
            p.stockCnt,
            p.reservationData?.reservationStockCnt,
        );
