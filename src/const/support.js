// 직영점
export const MAP_CLIENT_ID = process.env.REACT_APP_MAP_CLIENT_ID || 'i1nv00h8zo';
...
export const articles = [
  ...
  '회원 가입',
  '회원 정보 변경',
  '회원 탈퇴,자격상실 및 서비스 이용 제한 등',
  '회원 탈퇴에 따른 개인정보 보유 만료 및 멤버십제도 사용권 소멸',
  '회원에 대한 통지',
  '구매 신청',
  '계약의 성립',
  '지급 방법',
  '수신 확인 및 구매 신청 변경 및 취소',
  '재화 등의 공급',
  '환급',
  '청약 철회 등',
  '청약 철회 등의 효과',
...
export const policies = [
  ...
  '개인정보의 수집 및 이용목적',
  '개인정보 수집항목 및 수집방법',
  '개인정보의 보유, 이용기간, 파기절차, 제3자 제공 및 위탁',

  '고객님 및 법정대리인의 권리 - 개인정보의 열람, 정정, 삭제',
