...
const App = (props) => {
    ...
    const getMallInfo = async () => {
        if (
            ...
            window.location.pathname === '/member/joinStep'
        ) {
            return;
        }
        if (isLogin) {
        ...
        <div className='App' onScroll={handleScroll}>
            {isStatus ? (
                <div className='wrapper' style={{ backgroundColor: 'white' }}>
                    ...
                    {/* 헤더 */}
                    {popups.length > 0 && (
                        <CustomPopup location={location} data={popups} />
                    )}
                    ...
                    <Switch>
                        ...
                        <Route
                            exact
                            path='/purchase-consulting'
                            component={purchaseConsulting}
                        />
                        ...
                        <Route
                            exact
                            path='/my-page/order-detail'
                            component={orderDetail}
                        />
                        <Route
                            exact
                            path='/my-page/order-list'
                            component={orderList}
                        />
                        <Route
                            exact
                            path='/my-page/old-order-list'
                            component={OldOrderList}
                        />
                        <Route
                            exact
                            path='/my-page/rename'
                        ...
                        <Route
                            exact
                            path='/event/asc/:eventNo'
                            component={asc}
                        />
                        <Route
                            exact
                            path='/event/refined/:eventNo'
                            component={refined}
                        />
                        <Route
                            exact
                            path='/event/live-on/:eventNo'
                            component={liveon}
                        />
                        <Route
                            exact
                            path='/event/refurbish/:eventNo'
                            component={refurbish}
                        />
                        <Route
                            exact
                            path='/event/employee/:eventNo'
                            component={employee}
                        />
                        ...
                        <Route
                            exact
                            path='/member/inactiveAccounts'
                            component={InactiveAccounts}
                        />
                        <Route
                            exact
                            path='/member/activeAccounts'
                            component={ActiveAccounts}
                        />
                        <Route
                            exact
                            path='/member/lockedAccounts'
                        ...
                        {agent.isApp && (
                            <>
                                ...
                                <Route
                                    exact
                                    path='/app/terms/privacy'
                                    component={TermsPrivacy}
                                />
                                <Route
                                    exact
                                    path='/app/terms/license'
                                    component={TermsLicense}
                                />
                            </>
                        )}
